...
class AppColors {
  ...
  static const MaterialColor primaryMaterialColor = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xFFFBAA29),
      100: Color(0xFFFBAA29),
      200: Color(0xFFFBAA29),
      300: Color(0xFFFBAA29),
      400: Color(0xFFFBAA29),
      500: Color(0x00FBAA29),
      600: Color(0xFFFBAA29),
      700: Color(0xFFFBAA29),
      800: Color(0xFFFBAA29),
      900: Color(0xFFFBAA29),
    },
  );

  static const primaryColor = Color(0xFFFBAA29);
  static const primaryLightColor = Color(0xFFFDD494);
  static const backgroundColor = Color(0xFF060606);
  static const cardBackgroundColor = Color(0xFFFFFFFF);
  static const hintColor = Color(0xFF7D7E80);
  ...
  static const textFillColorColor = Color(0xFFF4F6F9);
